...
ggplot(NULL,aes(y=sort(average_stid$average_stid), x=sort(reports_per_time$c))) + geom_point() + geom_smooth(method="lm", se=FALSE) + labs(title="Q-Q Plot", x="Number of reports per 5 mins", y="Average Status Id per 5 mins")
```
